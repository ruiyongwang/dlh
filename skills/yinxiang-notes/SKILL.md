...
| `get_note_content.py` | 获取笔记内容预览和纲要 |
...
```bash
# 通过标题获取
python skills/yinxiang-notes/scripts/get_note_content.py --title "笔记标题"

# 通过 GUID 获取
python skills/yinxiang-notes/scripts/get_note_content.py --guid "笔记GUID"
```

返回内容预览（1000字）和自动提取的纲要。
